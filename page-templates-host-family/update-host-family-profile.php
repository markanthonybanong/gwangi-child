<?php
/*
 * Template Name: Update Host Family Profile
 * description: >-
  Active aupair host family update form
 */
get_header();
?>
<?php
    ...
    require get_theme_file_path('inc/host-family/update-host-family/update-host-family-db.php');
    require get_theme_file_path('inc/host-family/update-host-family/update-host-family-utils.php');

    $variables    = new Variables();
    $common_utils = new Common_Utilities();
    $host_family  = new Host_Family();
    $db           = new Update_Host_Family_Db($wpdb);
    $utils        = new Update_Host_Family_Utils(
                        $variables,
                        $db->get_login_host_family(),
                        $db->get_login_host_family_preferred_nationalities(),
                        $db->get_login_host_family_applicants_living_in(),
                        $db->get_login_host_family_languages_spoken_at_home()
                    );
?>
        ...
        <h3 class="add-border-bottom">Upload Photo</h3>
            <div class="upload-photo-container">
                <div class="column-one">
                        <div class="host-family-photo-parent-container">
                            <div class="host-family-photo-container">
                                <?php
                                    if( $db->get_login_host_family()->photo != ""){
                                        $imgSrc = get_stylesheet_directory_uri().'/users-photo/host-family/'.$db->get_login_host_family()->photo;
                                        echo "<img src='".$imgSrc."' alt='host-family-photo' id='user-photo'>";
                                    } else {
                        ...
                        <input type="file" name="host-family-photo" id="host-family-photo"/>
                        <div class="photo-privacy-container">
                            <h5>Photo Privacy <span id="required">*</span></h5>
                            <div class="radio-button-fields">
                                <div id="input-1">
                                    <input type="radio" name="photo-privacy" id="public" value="Public" <?php echo $utils->selected_photo_privacy("Public");?>>
                                    <label for="public" class="photo-privacy">Public</label><br>
                                </div>
                                <div id="input-2">
                                    <input type="radio" name="photo-privacy" id="registered-members" value="Registered Members"<?php echo $utils->selected_photo_privacy("Registered Members");?>>
                        ...
                        <div class="photo-description-container">
                            ...
                            <div class="center">
                                <textarea name="photo-description" id="photo-description" maxlength='163'><?php echo $db->get_login_host_family()->photo_description;?></textarea>
                            </div>
                        </div>
                ...
                <div class="column-two">
                        <h5><i class="bi bi-check"></i>First impression counts!</h5>
                        <h5>Make sure your photos</h5>
                        <p>show you, your family or the region you live in</p>
                        <p>are authentic</p>
                        <p>make a first good impression</p>
                        <p>are appropriate for our platform</p>
                </div>                  
            </div>    
                    ...
                    <div class="children-people-taken-care">
                        <div class="center">
                            <div class="registration-input">
                                <div class="label-container">
                                    <div>
                                        <h6>How many children would you like to be taken care of?<span id="required">*</span></h6>
                                    </div>
                                </div>
                                <div class="field-container">
                    ...
                    <div class="take-care-children-special-needs">
                        <div class="center"> 
                            <div class="registration-radio-button">
                                ...
                                <div class="radio-button-fields">
                                    <div id="input-1">
                                    <input type="radio" name="take-care-children-with-special-needs" id="take-care-children-with-special-needs-yes" value="Yes" <?php echo $utils->selected_take_care_children_with_special_needs("Yes");?>>
                                    <label for="take-care-children-with-special-needs-yes" class="take-care-children-with-special-needs">Yes</label><br>
                                    </div>
                                    <div id="input-2">
                                    <input type="radio" name="take-care-children-with-special-needs" id="take-care-children-with-special-needs-no" value="No" <?php echo $utils->selected_take_care_children_with_special_needs("No");?>>
                    ...
                    <div class="registration-input">
                        ...
                        <div class="field-container">
                            <select id="field" name="where-do-you-live" class="where-do-you-live">
                                ...
                                <option value="Village" <?php echo $utils->selected_where_do_you_live("Village");?>>Village</option>
