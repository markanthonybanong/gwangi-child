        ...
        <div class="active-aupair-parent-container">
            <div class="active-aupair-container">
                <form action="" method="post">
                        ...
                        <div class="center">
                            <div>
                                <div class="registration-checkbox">
                                    <label><input type="checkbox" name="looking-for[]" class="un-check" id="aupair" value="aupair"/> Aupair</label>
                                    <label><input type="checkbox" name="looking-for[]" class="un-check" id="nanny" value="nanny"/> Nanny</label>
                                    <label><input type="checkbox" name="looking-for[]" class="un-check" id="granny-aupair" value="granny aupair"/> Granny aupair</label>
                                    <label><input type="checkbox" name="looking-for[]" class="un-check" id="caregiver-for-elderly" value="caregiver for elderly"/> Caregiver for elderly</label>
                                </div> 
                                <div class="registration-checkbox">
                                    <label><input type="checkbox" name="looking-for[]" class="un-check" id="live-in-help" value="live in help"/> Live in help</label>
                                    <label><input type="checkbox" name="looking-for[]" class="un-check" id="live-in-tutor" value="live in tutor"/> Live in tutor</label>
                                    <label><input type="checkbox" name="looking-for[]" class="un-check" id="online-tutor" value="online tutor"/> Online tutor</label>
                                    <label><input type="checkbox" name="looking-for[]" class="un-check" id="virtual-childcare" value="virtual childcare"/> Virtual Childcare</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="take-care-of-children">
                                <h3 class="add-border-bottom">Aupair, Nanny & Granny Aupair</h3>
                                    ...
                                    <div class="center">
                                        <div>
                                        <div class="registration-checkbox">
                                            <label><input type="checkbox" name="take-care-children[]" value="0 - 1 year old"/> 0 - 1 year old</label>   
                                            <label><input type="checkbox" name="take-care-children[]" value="1 - 5 years old"/> 1 - 5 years old</label>
                                            <label><input type="checkbox" name="take-care-children[]" value="6 - 10 years old"/> 6 - 10 years old</label>
                                            <label><input type="checkbox" name="take-care-children[]" value="11 - 14 years old"/> 11 - 14 years old</label>
                                        </div>
                                        <div class="registration-checkbox">
                                            <label><input type="checkbox" name="take-care-children[]" value="15+ years old"/> 15+ years old</label>
                                        </div>
                                        </div>
                                    </div>
                            </div>
                                ...
                                <div class="center">
                                    <div class="registration-input">
                                        ...
                                        <div class="field-container">
                                            <select id="field" name="hours-child-care-experience">
                            ...
                            <div class="children-people-taken-care">
                                <div class="center">
                                    <div class="registration-input">
                                        ...
                                        <div class="field-container">
                                           <input id="field" type="number" name="how-many-children-people-would">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="center"> 
                                    <div class="registration-radio-button">
                                        ...
                                        <div class="radio-button-fields">
                                            ...
                                            <label for="take-care-children-with-special-needs-yes">Yes</label><br>
                                            </div>
                                            <div id="input-2">
                                            <input type="radio" name="take-care-children-with-special-needs" id="take-care-children-with-special-needs-no" value="no">
                                            <label for="take-care-children-with-special-needs-no">No</label><br>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="registration-radio-button">
                                    ...
                                    <div class="radio-button-fields">
                                        <div id="input-1">
                                            ...
                                            <label for="take-care-people-with-special-needs-yes">Yes</label><br>
                                        </div>
                                        <div id="input-2">
                                            <input type="radio" name="take-care-people-with-special-needs" id="take-care-people-with-special-needs-no" value="no">
                                            <label for="take-care-people-with-special-needs-no">No</label><br>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="price-per-hour">
                           <div class="center">
                              <div class="registration-input">
                                 ...
                                 <div class="field-container">
                                    <input type="number" id="field-1" name="price-per-hour" placeholder="Amount"/>
                                    <select id="field-2" name="currency">
                    ...
                    <div class="preferred-nationalities">
                        <h5>Preferred Nationalities<span id="required">*</span></h5>
                        <div class="center">
                            <div class="registraion-preferred-nationalities registration-checkbox">
                                <div>
                    ...
                    <div class="duration-of-stay">
                        ...
                        <div class="registration-input">
                            ...
                            <div class="field-container">
                                <select id="field" name="duration-of-stay">
                                    <option value="" disabled selected>Select</option>
                    ...
                    <div class="preferred-gender">
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <select id="field" name="preferred-gender">
                                        <option value="" disabled selected>Select</option>
                                        <option value="not important">Not Important</option>
                    ...
                    <div class="require-language-skills">
                        <div class="center">
                            <div class="registration-input">
                                <div class="label-container">
                                    <div>
                                ...
                                <div class="field-container">
                                    <select id="field" name="required-english-language-skills">
                                        <option value="" disabled selected>Select</option>
                                        <option value="not important">Not Important</option>
                    ...
                    <div class="require-education-level">
                        <div class="center">
                            <div class="registration-input">
                                <div class="label-container">
                                    <div>
                    ...
                    <div class="pocket-money-per-month">
                        <div class="center">
                            <div class="registration-input">
                                <div class="label-container">
                                ...
                                <div class="field-container">
                                    <input id="field-1" type="number" name="pocket-money-permonth" placeholder="Pocket money"/>
                    ...
                    <div class="willing-to-pay-share-travel-expenses">
                        <div class="center">
                            <div class="registration-input">
                                <div class="label-container">
                                ...
                                <div class="field-container">
                                    <select id="field" name="pay-for-travel-expenses">
                                        <option value="" disabled selected>Select</option>
                    ...
                    <div class="willing-to-pay-share-visa">
                        <div class="center">
                            <div class="registration-input">
                                <div class="label-container">
                                ...
                                <div class="field-container">
                                    <select id="field" name="pay-for-visa">
                                        <option value="" disabled selected>Select</option>
                                        <option value="applicant should pay for everything">Applicant should pay for everything</option>
                    ...
                    <div class="required-age">
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <select id="field-1" class="required-age-min" name="earliest-starting-date-month">
                                        <option value="" disabled selected>Min</option>
                                    </select>
                                    <select id="field-2" class="required-age-max" name="earliest-starting-date-year">
                    ...
                    <div class="is-smoking-allowed">
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <select id="field" name="is-smoking-allowed">
                                        <option value="" disabled selected>Select</option>
                    ...
                    <div class="applicant-take-care-of-pets">
                        <div class="center">
                            <div class="registration-radio-button">
                                ...
                                <div class="radio-button-fields">
                                    <div id="input-1">
                                        ...
                                        <label for="applicant-take-care-of-pets-yes">Yes</label><br>
                                    </div>
                                    <div id="input-2">
                                        <input type="radio" name="applicant-take-care-of-pets" id="applicant-take-care-of-pets-no" value="no">
                                        <label for="applicant-take-care-of-pets-no">No</label><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="applicant-know-how-to-swim">
                        <div class="center">
                            <div class="registration-radio-button">
                                ...
                                <div class="radio-button-fields">
                                    <div id="input-1">
                                        ...
                                        <label for="applicant-know-how-to-swim-yes">Yes</label><br>
                                    </div>
                                    <div id="input-2">
                                        <input type="radio" name="applicant-know-how-to-swim" id="applicant-know-how-to-swim-no" value="no">
                                        <label for="applicant-know-how-to-swim-no">No</label><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="applicant-know-how-to-ride-a-bike">
                        <div class="center">
                            <div class="registration-radio-button">
                                ...
                                <div class="radio-button-fields">
                                    <div id="input-1">
                                        ...
                                        <label for="applicant-know-how-to-ride-bike-yes">Yes</label><br>
                                    </div>
                                    <div id="input-2">
                                        <input type="radio" name="applicant-know-how-to-ride-bike" id="applicant-know-how-to-ride-bike-no" value="no">
                                        <label for="applicant-know-how-to-ride-bike-no">No</label><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="does-applicant-have-first-aid-training">
                        <div class="center">
                            <div class="registration-radio-button">
                                <h5>Do you expect that the Applicant to attend a First Aid Training?<span id="required">*</span></h5>
                                <div class="radio-button-fields">
                                    <div id="input-1">
                                        <input type="radio" name="applicant-first-aid-training" id="applicant-first-aid-training-yes" value="yes">
                                        <label for="applicant-first-aid-training-yes">Yes</label><br>
                                    </div>
                                    <div id="input-2">
                                        <input type="radio" name="applicant-first-aid-training" id="applicant-first-aid-training-no" value="no">
                                        <label for="applicant-first-aid-training-no">No</label><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="do-you-expect-applicant-to-drive">
                        <div class="center">
                            <div class="registration-radio-button">
                                ...
                                <div class="radio-button-fields">
                                    <div id="input-1">
                                        ...
                                        <label for="applicant-to-drive-yes">Yes</label><br>
                                    </div>
                                    <div id="input-2">
                                        <input type="radio" name="applicant-to-drive" id="applicant-to-drive-no" value="no">
                                        <label for="applicant-to-drive-no">No</label><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="can-the-applicant-attend-language-courses">
                        <div class="center">
                            <div class="registration-radio-button">
                                ...
                                <div class="radio-button-fields">
                                    <div id="input-1">
                                        ...
                                        <label for="applicant-to-attend-language-courses-yes">Yes</label><br>
                                    </div>
                                    <div id="input-2">
                                        <input type="radio" name="applicant-to-attend-language-courses" id="applicant-to-attend-language-courses-no" value="no">
                                        <label for="applicant-to-attend-language-courses-no">No</label><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                     ...
                     <div class="are-you-a-single-parent">
                        <div class="center">
                            <div class="registration-input">
                                <div class="label-container">
                                    <div>
                                ...
                                <div class="field-container">
                                    <select id="field"  name="are-you-single-parent">
                                        <option value="" disabled selected>Select</option>
                     ...
                     <div class="parents-age-group">
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <select id="field"  name="parents-age-group">
                                        <option value="" disabled selected>Select</option>
                     ...
                     <div class="is-religion-important-container">
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <select id="field" name="religion-important-to-you">
                                        <option value="" disabled selected>Select</option>
                                        <option value="not important">Not Important</option>
                    ...
                    <div class="employment-parent-1-container">
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <input id="field" type="text" name="employement-parent-1" placeholder="Employment">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="people-living-in-house-container">
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <input id="field" type="number" name="how-many-people-living-in-the-house" placeholder="No. of people living in the house">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="center">
                            ...
                            <div class="radio-button-fields">
                                <div id="input-1">
                                    ...
                                    <label for="have-pets-yes">Yes</label><br>
                                </div>
                                <div id="input-2">
                                    <input type="radio" name="have-pets" id="have-pets-no" value="no">
                                    <label for="have-pets-no">No</label><br>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="where-do-you-live-container">
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <select id="field" name="where-do-you-live">
                                        <option value="" disabled selected>Select</option>
                    ...
                    <div class="firstname-container">
                        ...
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <input id="field" type="text" name="firstname" placeholder="Firstname"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="lastname-container">
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <input id="field" type="text" name="lastname" placeholder="Lastname"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="address-container">
                        ...
                        <div class="registration-input">
                            ...
                            <div class="field-container">
                                <input id="field" type="text" name="address" placeholder="Address"/>
                            </div>
                        </div>
                        </div>
                    </div>
                    <div class="zip-code-container">
                        <div class="center">
                            <div class="registration-input">
                                ...
                                <div class="field-container">
                                    <input id="field" type="text" name="zip-code" placeholder="Zip code"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="city-container">
                      <div class="center">
                         <div class="registration-input">
                            ...
                            <div class="field-container">
                               <input id="field" type="text" name="city" placeholder="City"/>
                            </div>
                         </div>
                      </div>
                    </div>
                    <div class="state-container">
                        ...
                        <div class="registration-input">
                            ...
                            <div class="field-container">
                                <input id="field" type="text" name="state-region" placeholder="State/Region"/>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="letter-to-the-applicant">
                       <h3 class="add-border-bottom">Letter to the Applicant</h3>
                       <h5>Letter<span id="required">*</span></h5>
                       <div class="center">
                           <textarea id="text-area" name="letter-to-the-applicant">
                           </textarea>
                       </div>
                    </div>
                    <div class="email-add-container">
                       <h3 class="add-border-bottom">Login Information</h3>
                       <div class="center">
                          <div class="registration-input">
                             <div class="label-container">
                                <div>
                             ...
                             <div class="field-container">
                                <input id="field" type="text" name="email" placeholder="Email"/>
                             </div>
                          </div>
                       </div>
                    </div>
                    <div class="password-container">
                        <div class="center">
                           <div class="registration-input">
                              ...
                              <div class="field-container">
                                 <input id="field" type="password" name="password" placeholder="Password"/>
                              </div>
                           </div>
                        </div>
                    </div>
                    <div class="confirm-password-container">
                       <div class="center">
                          <div class="registration-input">
                             ...
                             <div class="field-container">
                                <input id="field" type="password" name="confirm-password" placeholder="Confirm password"/>
                             </div>
                          </div>
                       </div>
                    </div>
...
if(isset($_POST['submit'])){
    ...
    // foreach($looking as $job) {
    //     echo $job;
    // }

    //SELECTBOX
    // $earliestStartingDateMonth = $_POST['earliest-starting-date-month'];
    // echo $earliestStartingDateMonth;

    //RADIO BUTTON
    // $takeCareOfChildrenWithSpecialNeeds = $_POST['take-care-children-with-special-needs'];
    // echo $takeCareOfChildrenWithSpecialNeeds;
}  
get_footer();
?>