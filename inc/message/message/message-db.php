<?php
    class MessageHostFamilyDb{
        ...
        public function get_host_family($host_family_id){
        ...
        public function get_send_msgs(){
            $sender   = get_current_user_id();
            $receiver = $_GET['to-send-msg-id'];
            return $this->_wpdb->get_results("SELECT * FROM aupair_messages WHERE from_wp_user_id  = '".$sender."' AND to_wp_user_id = '".$receiver."'");
        }
