<?php
    class Register_Host_Family_Utils{
        ...
        private function selected_home_languages($language){
            $checked = null;
            if(isset($_POST['register']) && in_array($language, $_POST['spoken-at-home-languages'])){
                $checked = "checked";
            }  
            return $checked;
        }
        ...
        public function selected_preferred_nationality($nationality){
            $checked = null;
            if(isset($_POST['register']) && in_array($nationality, $_POST['preferred-nationalities'])){
                $checked = "checked";
            }  
            return $checked;
        }
        public function selected_applicant_living_in($country){
            $checked = null;
            if(isset($_POST['register']) && in_array($country, $_POST['applicant-living-in'])){
                $checked = "checked";
            }  
            return $checked;    
        }
        ...
        // //we are looking-for
        public function selected_we_are_looking_for($job){
             $checked = null;
             if(isset($_POST['register']) && in_array($job, $_POST['looking-for'])){
                 $checked = "checked";
             }
             return $checked;
        }
        ...
        public function selected_take_care_children_with_spcial_needs($answer){
            $checked = null;
            if(isset($_POST['register'])){
                if(
                    in_array("aupair", $_POST['looking-for']) ||
        ...
        public function selected_student_age_group($age){
            $checked = null;
            if(isset($_POST['register'])){
                if( in_array("live in tutor", $_POST['looking-for'])){
                    if(in_array($age, $_POST['student-age-group'])){
                        $checked = "checked";
                    }
                }
            }
        ...
        public function selected_duration_of_stay($duration){
            $selected = null;
            if(isset($_POST['register']) && $_POST['duration-of-stay'] === $duration){
                $selected = "selected";
            }  
            return $selected;
        }
        ...
        public function selected_preferred_gender($answer){
            $selected = null;
            if(isset($_POST['register']) && $_POST['preferred-gender'] === $answer){
                $selected = "selected";
            }  
            return $selected;
        }
        ...
        public function selected_working_hours($hours){
            $selected = null;
            if(isset($_POST['register']) && $_POST['working-hours-per-week'] === $hours){
                $selected = "selected";
            }
            return $selected;
        }
        ...
        public function selected_willing_to_pay_for_travel_expenses($answer){
            $selected = null;
            if(isset($_POST['register']) && $_POST['pay-for-travel-expenses'] === $answer){
                $selected = "selected";
            }
            return $selected;
        }
        ...
        public function selected_willing_to_pay_for_visa($answer){
            $selected = null;
            if(isset($_POST['register']) && $_POST['pay-for-visa'] === $answer){
                $selected = "selected";
            }
            return $selected;
        }
        ...
        public function selected_is_smoking_allowed($answer){
            $selected = null;
            if(isset($_POST['register']) && $_POST['is-smoking-allowed'] === $answer){
                $selected = "selected";
            }
            return $selected;
        }
        ...
        public function selected_applicant_have_to_take_care_of_pets($answer){
            $checked = null;
            if(isset($_POST['register']) && $_POST['applicant-take-care-of-pets'] === $answer){
                $checked = "checked";
            }
            return $checked;
        }
        ...
        public function selected_applicant_know_how_to_swim($answer){
            $checked = null;
            if(isset($_POST['register']) && $_POST['applicant-know-how-to-swim'] === $answer){
                $checked = "checked";
            }
            return $checked;
        }
        ...
        public function selected_applicant_know_how_to_ride_a_bike($answer){
            $checked = null;
            if(isset($_POST['register']) && $_POST['applicant-know-how-to-ride-bike'] === $answer){
                $checked = "checked";
            }
            return $checked;
        }
        ...
        public function selected_expect_applicant_to_drive($answer){
            $checked = null;
            if(isset($_POST['register']) && $_POST['applicant-to-drive'] === $answer){
                $checked = "checked";
            }
            return $checked;
        }
        ...
        public function selected_expect_applicant_have_training_in_healthcare($answer){
            $checked = null;
            if(isset($_POST['register']) && $_POST['applicant-attend-first-aid-training'] === $answer){
                $checked = "checked";
            }
            return $checked;
        }
        ...
        public function selected_are_you_a_single_parent($answer){
            $selected = null;
            if(isset($_POST['register']) && $_POST['are-you-single-parent'] === $answer){
                $selected = "selected";
            }
            return $selected;
        }
        ...
        public function selected_parents_age_group($age){
            $selected = null;
            if(isset($_POST['register']) && $_POST['parents-age-group'] === $age){
                $selected = "selected";
            }
            return $selected;
        }
        ...
        public function selected_is_religion_important_to_you($answer){
             $selected = null;
             if (isset($_POST['register']) && $_POST['religion-important-to-you'] === $answer) {
                 $selected = "selected";
             }
             return $selected;
        }
        ...
        public function selected_have_any_pets($answer){
             $checked = null;
             if (isset($_POST['register']) && $_POST['have-pets'] === $answer) {
                 $checked = "checked";
             }
             return $checked;
        }
        ...
        public function selected_where_do_you_live($answer){
             $selected = null;
             if (isset($_POST['register']) && $_POST['where-do-you-live'] === $answer) {
                 $selected = "selected";
             }
             return $selected;
        }
        ...
        //email 
        public function inputted_email_address(){
            $email = null;
            if(isset($_POST['register'])){
                $email = $_POST['email'];
            }
        ...
        //confirm-email 
        public function inputted_confirm_email_address(){
            $email = null;
            if(isset($_POST['register'])){
        ...
        //password 
        public function inputted_password(){
            $password = null;
            if(isset($_POST['register'])){
        ...
        //confirm password
        public function inputted_confirm_password(){
            $password = null;
            if(isset($_POST['register'])){
