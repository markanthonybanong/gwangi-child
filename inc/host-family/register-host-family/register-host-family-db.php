<?php 
    class Register_Host_Family_Db{
        ...
        public function insert($host_family){
            $data = array(
                        'wp_user_id'                                              => $host_family->wp_user_id,   
                        ...
                        'user_type'                                               => 'host-family'                                               
            );
            add_user_meta($host_family->wp_user_id, 'user_type', 'host-family');
            return $this->_wpdb->insert('aupair_registered_host_family', $data);
            
        }
        public function insert_preferred_nationality($wp_user_id, $nationality){
             $data = array(
        ...
        public function insert_applicant_living_in($wp_user_id, $country){
            $data = array(
               'wp_user_id' => $wp_user_id,
               'country'    => $country
            );
       ...
       public function insert_spoken_at_home_language($wp_user_id, $language){
            $data = array(
               'wp_user_id' => $wp_user_id,
               'language'   => $language
            );
