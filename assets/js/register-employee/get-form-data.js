export function getFormData(){
    ...
    function preferredCountries() {
        let countries = [];
        if($('.registration-countries input[name="select-all"]').is(':checked')) {
            countries.push('All Countries');
        } else if($('.registration-countries input[name="select-eu"]').is(':checked') && selectedOtherCountry() === false) {
            countries.push('EU Countries');
        } else if($('.registration-countries input[name="select-eu"]').is(':checked') && selectedOtherCountry() === true){
            countries.push('EU Countries');
    ...
    function fields(data){
        ...
        data.healthProblemsAllergy     = $.trim($('.have-health-problems-or-allergies').val());
        ...
        data.mobilePhoneNo             = $('.mobile-number').val();
