export function checkEmptyPersonalInformationFields(isThereEmptyFields){
    ...
    if($.trim($('.have-health-problems-or-allergies').val()) === ""){
        isThereEmptyFields.push(true);
        $('.have-health-problems-or-allergies').addClass('required-border');
        $('.warning-msg').append($('<p id="required"></p>').text('Do you have any health... cannot be left empty'));
    }
