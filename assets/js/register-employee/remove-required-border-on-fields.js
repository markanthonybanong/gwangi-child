export function removeRequiredBorderOnFields() {
    ...
    const takeCareChildrenRB = $('input[name="take-care-children-with-special-needs"]').change(function(){
        if($('.take-care-children-with-special-needs').hasClass('required-border')){
    ...
    const haveHealthProblemsAllergiesIF = $('.have-health-problems-or-allergies').click(function(){
        if($('.have-health-problems-or-allergies').hasClass('required-border')){
            $('.have-health-problems-or-allergies').removeClass('required-border');
        }
    });
    //do you smoke
    ...
    //username
    const usernameIF = $('.account-username').click(function(){
        if($('.account-username').hasClass('required-border')){
            $('.account-username').removeClass('required-border');
        }
    });
    //email
    ...
    return {
        ...
        haveHealthProblemsAllergiesIF: haveHealthProblemsAllergiesIF,
