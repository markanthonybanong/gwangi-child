...
export function getFormData(){
    ...
    function fields(data){
        ...
        data.age                           = date.getFullYear() - $('.r-e-date-of-birth-year').val();
        ...
        if($('input[name="currently-living"]:checked').val() === 'Another country') {
            data.employeeLivingIn          = $('.currently-living-select').val();
        } else {
            data.employeeLivingIn          = $('.e-r-country-select').val();
        }
